  ...
  const phases = [
    ...
    },
    {
      ...
      text: {
        ...
        fr: "Maintenant, nous relâchons les tensions internes. Sentez l'intérieur de votre poitrine, détendez vos poumons et calmez votre cœur. Sentez votre estomac et vos intestines, libérant tout nœud, tension ou crispation. Prenez conscience de votre intérieur doux, chaleureux et lumineux, comme un refuge de paix.",
